...
def index():
  ...
  if form.validate_on_submit():
  	...
  	dataset, links, query_list, epic_query_string = get_jira_query_results(form.query.data)
  ...
  return render_template('index.html', form=form, dataset=dataset, links=links, query_list=query_list, epic_dataset=epic_dataset)
